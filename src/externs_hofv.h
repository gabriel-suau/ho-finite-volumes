...
extern int (*HOFV_priToCons)(const double rho, const double S, double p[2], double c[2]);
extern int (*HOFV_consToPri)(const double rho, const double S, double c[2], double p[2]);
