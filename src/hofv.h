...
/* int HOFV_priToCons_proj(const double rho, const double S, double p[2], double c[2]); */
/* int HOFV_consToPri_proj(const double rho, const double S, double c[2], double p[2]); */
